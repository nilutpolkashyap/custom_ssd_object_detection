...
tf.app.flags.DEFINE_string(
    'train_dir', 'F:/github/custom_ssd_object_detection/log/',
...
tf.app.flags.DEFINE_float(
    'gpu_memory_fraction', 0.9, 'GPU memory fraction to use.')        #0.8

# =========================================================================== #
# Optimization Flags.
# =========================================================================== #
tf.app.flags.DEFINE_float(
    'weight_decay', 0.0005, 'The weight decay on the model weights.')    #0.00004
tf.app.flags.DEFINE_string(
    'optimizer', 'adam',
    'The name of the optimizer, one of "adadelta", "adagrad", "adam",'
    '"ftrl", "momentum", "sgd" or "rmsprop".')          #rmsprop
tf.app.flags.DEFINE_float(
    'adadelta_rho', 0.95,
...
tf.app.flags.DEFINE_string(
    'checkpoint_model_scope', 'ssd_300_vgg/conv6,ssd_300_vgg/conv7,ssd_300_vgg/block8,ssd_300_vgg/block9,ssd_300_vgg/block10,ssd_300_vgg/block11,ssd_300_vgg/block4_box,ssd_300_vgg/block7_box,ssd_300_vgg/block8_box,ssd_300_vgg/block9_box,ssd_300_vgg/block10_box,ssd_300_vgg/block11_box',
    'Model scope in the checkpoint. None if the same as the trained model.')      #None
tf.app.flags.DEFINE_string(
